...
main(int argc, char* argv[])
{
  ...
  topologyReader.SetFileName("src/ndnSIM/examples/topologies/wq-compute-once-topo2.txt");
  topologyReader.Read();
  ...
  for (int i=0; i<7; i++) 
  {
    ...
    ndn::AppHelper producerHelper("ns3::ndn::WqCheckpointMapper");
  ...
  for (int j=0; j<9; j++) 
  {
    ...
    ndn::AppHelper computeNodeHelper("ns3::ndn::WqCheckpointReducer");    
  ...
  ndn::AppHelper consumerHelper("ns3::ndn::WqCheckpointSink");
